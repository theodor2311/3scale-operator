...
func NewZyncOptionsProvider(apimanagerSpec *appsv1alpha1.APIManagerSpec, namespace string, client client.Client) *ZyncOptionsProvider {
...
func (z *ZyncOptionsProvider) GetZyncOptions() (*component.ZyncOptions, error) {
	z.zyncOptions.AppLabel = *z.apimanagerSpec.AppLabel
...
func (z *ZyncOptionsProvider) setResourceRequirementsOptions() {
	if *z.apimanagerSpec.ResourceRequirementsEnabled {
...
func (z *ZyncOptionsProvider) setReplicas() {
	z.zyncOptions.ZyncReplicas = int32(*z.apimanagerSpec.Zync.AppSpec.Replicas)
	z.zyncOptions.ZyncQueReplicas = int32(*z.apimanagerSpec.Zync.QueSpec.Replicas)
}
