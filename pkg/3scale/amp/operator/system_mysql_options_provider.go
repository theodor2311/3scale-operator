...
func NewSystemMysqlOptionsProvider(apimanagerSpec *appsv1alpha1.APIManagerSpec, namespace string, client client.Client) *SystemMysqlOptionsProvider {
...
func (s *SystemMysqlOptionsProvider) GetMysqlOptions() (*component.SystemMysqlOptions, error) {
	s.mysqlOptions.AppLabel = *s.apimanagerSpec.AppLabel
...
func (s *SystemMysqlOptionsProvider) setResourceRequirementsOptions() {
	if *s.apimanagerSpec.ResourceRequirementsEnabled {
